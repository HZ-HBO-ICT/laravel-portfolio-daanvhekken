...
<head>
    ...
    <meta name="description" content="Chronological journal about my program and career orientation experiences.">
</head>
<html lang="en">
    <body class="content">
       ...
       <a href="{{ url('') }}" onclick="close_sidemenu()" class="sidebar-item sidebar-button"><i
               class="bi bi-house me-2"></i>Home</a>
       <a href="{{ url('/dashboard') }}" onclick="close_sidemenu()" class="sidebar-item sidebar-button"><i
               class="bi bi-window-sidebar me-2"></i>Dashboard</a>
       <a href="{{ url('/profile') }}" onclick="close_sidemenu()" class="sidebar-item sidebar-button"><i
               class="bi bi-person-square me-2"></i>Profile</a>
       <a onclick="close_sidemenu()" class="sidebar-item sidebar-button" style="text-decoration: underline;"><i
               class="bi bi-newspaper me-2"></i>Blog</a>
       <a href="{{ url('/faq') }}" onclick="close_sidemenu()" class="sidebar-item sidebar-button"><i
               class="bi bi-question-square me-2"></i>Faq</a>
       <a href="{{ url('/contact') }}" onclick="close_sidemenu()" class="sidebar-item sidebar-button"><i
   ...
   <header class="topbar hide-large padding-16">
    ...
    <a href="javascript:void(0)" class="float-right sidebar-button" onclick="open_sidemenu()">
      <div id="nav-icon">
        ...
        <div class="mobile-overlay hide-large" onclick="close_sidemenu()" style="cursor:pointer"
